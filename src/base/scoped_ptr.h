...
//  method success.
#ifndef VZBASE_BASE_SCOPED_PTR_H__
#define VZBASE_BASE_SCOPED_PTR_H__
...
class scoped_ptr {
 ...
 public:
  ...
  operator Testable() const {
    return ptr ? &scoped_ptr::ptr : NULL;
  }
...
class scoped_array {
 ...
 public:
  ...
  operator Testable() const {
    return ptr ? &scoped_array::ptr : NULL;
  }
};
...
template<typename T, void (*FF)(T*) = free> class scoped_ptr_malloc {
 ...
 public:
  ...
  operator Testable() const {
    return ptr ? &scoped_ptr_malloc::ptr : NULL;
  }
};
...
#endif  // #ifndef VZBASE_BASE_SCOPED_PTR_H__
